...
inline fun <reified T> Context.startActivity(vararg bundlePair: BundlePair) {
    startActivity(
...
fun bundleOf(vararg pairs: BundlePair) =
        bundle {
...
infix fun String.bundleTo(value: java.io.Serializable) =
...
infix fun String.bundleTo(value: Array<out CharSequence>) =
        BundlePair { it[this] = value }

infix fun String.bundleTo(value: Array<out String>) =
        BundlePair { it[this] = value }

infix fun String.bundleTo(value: Array<out Parcelable>) =
        BundlePair { it[this] = value }

infix fun String.bundleTo(value: SparseArray<out Parcelable>) =
        BundlePair { it[this] = value }
